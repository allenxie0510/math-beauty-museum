...
export function buildLearningContent(conceptId: HometownConceptId, overlay: OverlayGeometry, interpretation = ""): MathLearningContent {
  ...
  if (conceptId === "symmetry.axial") return {
    ...
    variables: [{ symbol: "ℓ", meaning: "照片中标出的对称轴" }, { symbol: "P、P′", meaning: "轴线两侧的一对对应位置" }, { symbol: "d", meaning: "点到轴线的垂直距离" }],
  ...
  if (conceptId === "geometry.arch") return {
    ...
    variables: [{ symbol: "A、B", meaning: "拱的两个支点" }, { symbol: "C", meaning: "拱顶位置" }, { symbol: "ℓ_AB", meaning: "通过两个支点 A、B 的直线" }, { symbol: "L", meaning: "两支点之间的跨度" }, { symbol: "h", meaning: "拱顶到支点连线的垂直距离" }],
