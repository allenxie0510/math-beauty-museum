...
- `/api/observer/speech`：用 Qwen3-TTS 合成语音；未配置时自动降级为浏览器语音。
...
官方参考：[声音设计](https://help.aliyun.com/zh/model-studio/voice-design-user-guide)、[声音复刻](https://help.aliyun.com/zh/model-studio/voice-cloning-user-guide)、[非实时语音合成](https://help.aliyun.com/zh/model-studio/non-realtime-tts-user-guide)。
