...
export const MATH_OBSERVER_PROFILES: Record<MathObserverParticipation, MathObserverProfile> = {
  quiet: { threshold: .84, multiplier: .76, cooldownMs: 30000, idleMs: 46000 },
  balanced: { threshold: .68, multiplier: 1, cooldownMs: 15000, idleMs: 30000 },
  active: { threshold: .53, multiplier: 1.22, cooldownMs: 8000, idleMs: 22000 },
};
